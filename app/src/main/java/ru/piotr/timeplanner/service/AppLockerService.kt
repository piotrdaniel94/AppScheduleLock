package ru.piotr.timeplanner.service
...
import ru.piotr.timeplanner.service.notification.ServiceNotificationManager
import ru.piotr.timeplanner.service.stateprovider.AppForegroundObservable
...
import ru.piotr.timeplanner.service.stateprovider.PermissionCheckerObservable
...
//        ServiceStarter.startService(applicationContext)
    ...
    private fun observeLockedApps() {
        allDisposables.add(lockedAppsDao.getLockedApps()
...
//                startActivity(intent)
                ...
                Log.e("LockApp-----MYJ", lastForegroundAppPackage.toString());
